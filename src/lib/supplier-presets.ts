...
export const SUPPLIER_PRESETS: SupplierPreset[] = [
  ...
  },
  {
    ...
    aliases: ["автофлагман", "флагман", "flagman", "avtoflagman", "flagman auto", "flagmanauto"],
  },
  {
    id: "auger",
    name: "Auger GERMANY",
  ...
  filePreset("emex", "EMEX", "EMEX", "emex.png", ["emex", "емех", "эмекс"]),
  filePreset("euro-auto", "euro auto", "EUROAUTO", "euro-auto.png", [
    "euro auto",
    "euroauto",
    "евро авто",
    "евроавто",
  ]),
  filePreset("faeton37", "Faeton37", "FAETON", "faeton37.png", ["faeton37", "faeton", "фаэтон"]),
  filePreset("favorit", "FAVORIT", "FAVORIT", "favorit.png", ["favorit", "фаворит"]),
  filePreset("fenix", "Феникс", "FENIX", "fenix.png", ["феникс", "fenix", "phoenix"]),
  filePreset("fixauto", "FIXAUTO", "FIXAUTO", "fixauto.png", ["fixauto", "fix auto", "фиксавто"]),
  filePreset("formula1", "Formula1", "F1PARTS", "formula1.png", [
    "formula1",
    "formula 1",
    "формула1",
    "f1 parts",
  ]),
  filePreset("forum-auto", "FORUM-AUTO", "FORUM", "forum-auto.png", [
    "forum-auto",
    "forum auto",
    "forumauto",
    "форум авто",
  ]),
  filePreset("froza", "FROZA", "FROZA", "froza.png", ["froza", "фроза"]),
  filePreset("genesis-10f", "GENESIS-10F", "GENESIS", "genesis-10f.png", [
    "genesis-10f",
    "genesis 10f",
    "genesis10f",
    "генезис",
  ]),
  filePreset("gef-parts", "GEF PARTS", "GEF", "gef-parts.png", ["gef parts", "gefparts", "gef"]),
  filePreset("gpi", "GPI G'PARTS IMPORT", "GPI", "gpi.png", [
    "gpi",
    "gparts import",
    "g'parts",
    "джипиай",
  ]),
  filePreset("help-auto24", "Help-auto24.ru", "HELPAUTO", "help-auto24.png", [
    "help-auto24",
    "help-auto24.ru",
    "help auto24",
    "хелп авто",
  ]),
  filePreset("inpartsgroup", "INPARTSGROUP", "INPARTS", "inpartsgroup.png", [
    "inpartsgroup",
    "inparts group",
    "inparts",
    "инпартс",
  ]),
  filePreset("intercar", "Intercar", "INTERCAR", "intercar.png", ["intercar", "интеркар"]),
  filePreset("ironunit", "IRONUNIT", "IRONUNIT", "ironunit.png", ["ironunit", "iron unit", "айроньюнит"]),
  filePreset("gears", "Gears", "GEARS", "gears.png", ["gears", "шестерни", "2gears"]),
  filePreset("iwc", "IWC", "IWC", "iwc.png", ["iwc", "айдаблсю"]),
  filePreset("ixora", "IXORA", "IXORA", "ixora.png", ["ixora", "иксора", "ixora auto parts"]),
  filePreset("ja-parts", "JA PARTS", "JAPARTS", "ja-parts.png", ["ja parts", "japarts", "джа партс"]),
  filePreset("jlr-detali", "JLR DETALI", "JLR", "jlr-detali.png", [
    "jlr detali",
    "jlr",
    "jaguar land rover",
    "джиэлар",
  ]),
  filePreset("just-auto-parts", "JUST AUTO PARTS", "JUSTAUTO", "just-auto-parts.png", [
    "just auto parts",
    "justauto",
    "джаст авто",
  ]),
  filePreset("ka-motors", "КА Моторс", "KAMOTORS", "ka-motors.png", [
    "ка моторс",
    "ka motors",
    "kamotors",
  ]),
  filePreset("km-h", "KM-H.RU", "KMH", "km-h.png", ["km-h.ru", "km-h", "км-х"]),
  filePreset("cockpit", "Кокпит", "COCKPIT", "cockpit.png", ["кокпит", "cockpit", "кокпит авто"]),
  filePreset("koleso", "Колесо", "KOLESO", "koleso.png", ["колесо", "koleso"]),
  filePreset("koreapart", "КореяПарт", "KOREA", "koreapart.png", [
    "кореяпарт",
    "корея парт",
    "koreapart",
    "korea part",
  ]),
  filePreset("leemancar", "Leemancar", "LEEMAN", "leemancar.png", ["leemancar", "leeman car", "лиманкар"]),
  filePreset("little-japan", "Little Japan", "LITJAPAN", "little-japan.png", [
    "little japan",
    "littlejapan",
    "литтл джапан",
  ]),
  filePreset("lynx", "LYNX", "LYNX", "lynx.png", ["lynx", "линкс"]),
  filePreset("mparts", "MParts", "MPARTS", "mparts.png", ["mparts", "m parts", "эмпартс"]),
  filePreset("man-trade", "MAN TRADE", "MANTRADE", "man-trade.png", [
    "man trade",
    "mantrade",
    "ман трейд",
    "мантрейд",
  ]),
  filePreset("mb-parts", "MB Parts", "MBPARTS", "mb-parts.png", ["mb parts", "mbparts", "мб партс"]),
  filePreset("mc-auto", "MC auto", "MCAUTO", "mc-auto.png", ["mc auto", "mcauto", "мс авто"]),
  filePreset("mp73", "MP73", "MP73", "mp73.png", ["mp73", "мп73"]),
  filePreset("mega-zap-auto", "MEGA-ZAP-AUTO", "MEGAZAP", "mega-zap-auto.png", [
    "mega-zap-auto",
    "megazap",
    "мега зап",
    "мегазап",
  ...
  filePreset("nextauto", "NEXTAUTO", "NEXTAUTO", "nextauto.png", [
    "nextauto",
    "next auto",
    "некстауто",
  ]),
  filePreset("nizhbel", "Нижбел", "NIZHBEL", "nizhbel.png", [
    "нижбел",
    "nizhbel",
    "ниж бел",
  ]),
  filePreset("oilcity", "oilCity", "OILCITY", "oilcity.png", [
    "oilcity",
    "oil city",
    "ойлсити",
    "ойл сити",
  ]),
  filePreset("omega", "Омега", "OMEGA", "omega.png", [
    "омега",
    "omega",
    "omega parts",
  ]),
  filePreset("osminog", "Осьминог", "OSMINOG", "osminog.png", [
    "осьминог",
    "osminog",
    "осминог",
  ]),
  filePreset("ostrov", "OSTROV", "OSTROV", "ostrov.png", ["ostrov", "остров", "ostrov auto"]),
  filePreset("partgrade", "PartGRADE", "PARTGRADE", "partgrade.png", [
    "partgrade",
    "part grade",
    "партгрейд",
  ]),
  filePreset("parteza", "PartezaAuto", "PARTEZA", "parteza.png", [
    "partezaauto",
    "parteza auto",
    "parteza",
    "партеза",
  ]),
  filePreset("partkom", "Партком", "PARTKOM", "partkom.png", [
    "партком",
    "partkom",
    "парт ком",
  ]),
  filePreset("parts-region", "PARTS REGION", "PARTSREG", "parts-region.png", [
    "parts region",
    "partsregion",
    "партс регион",
  ]),
  filePreset("partsib", "PartSib.ru", "PARTSIB", "partsib.png", [
    "partsib",
    "partsib.ru",
    "part sib",
    "партсиб",
  ]),
  filePreset("patriot-postavka", "Патриотпоставка", "PATRIOT", "patriot-postavka.png", [
    "патриотпоставка",
    "патриот поставка",
    "patriot postavka",
  ]),
  filePreset("pegas-avto", "Пегас Авто", "PEGAS", "pegas-avto.png", [
    "пегас авто",
    "pegas avto",
    "пегас",
  ]),
  filePreset("point", "POINT", "POINT", "point.png", ["point", "поинт", "point auto"]),
  filePreset("profit-liga", "Профит Лига", "PROFITLIGA", "profit-liga.png", [
    "профит лига",
    "profit liga",
    "профитлига",
  ]),
  filePreset("sale-parts", "sale-parts.ru", "SALEPARTS", "sale-parts.png", [
    "sale-parts.ru",
    "sale parts",
    "saleparts",
    "сейл партс",
  ]),
  filePreset("schoffer", "SCHOFFER", "SCHOFFER", "schoffer.png", [
    "schoffer",
    "шоффер",
    "schoffer auto",
  ]),
  filePreset("sellparts", "SellParts", "SELLPARTS", "sellparts.png", [
    "sellparts",
    "sell parts",
    "селлпартс",
  ]),
  filePreset("seven-cars", "7 seven cars", "SEVENCARS", "seven-cars.png", [
    "7 seven cars",
    "seven cars",
    "sevencars",
    "севен карс",
  ]),
  filePreset("stels-yug", "стелс-юг", "STELSYUG", "stels-yug.png", [
    "стелс-юг",
    "стелс юг",
    "stels-yug",
    "stels yug",
  ]),
  filePreset("stk-group", "STK GROUP", "STKGROUP", "stk-group.png", [
    "stk group",
    "stkgroup",
    "stk-group",
    "стк групп",
  ]),
  filePreset("pentosin", "PENTOSIN", "PENTOSIN", "pentosin.png", [
    "pentosin",
    "пентосин",
    "pentosin safety",
  ]),
  filePreset("stutzen", "Stutzen.ru", "STUTZEN", "stutzen.png", [
    "stutzen.ru",
    "stutzen",
    "штутцен",
  ]),
  ...
  filePreset("tss", "TSS ГРУППА ПАРТНЁРОВ", "TSSGROUP", "tss.png", [
  ...
  filePreset("trinity-parts", "TRINITY PARTS", "TRINITY", "trinity-parts.png", [
    "trinity parts",
    "trinityparts",
    "тринити партс",
  ]),
  filePreset("trak-forum", "ТРАК-ФОРУМ AUTO PARTS", "TRAKFORUM", "trak-forum.png", [
    "трак-форум",
    "трак форум",
    "trak-forum",
    "trak forum",
  ...
  filePreset("turncar", "TURNCAR.ru", "TURNCAR", "turncar.png", [
    "turncar.ru",
    "turncar",
    "турнкар",
  ]),
  filePreset("yugavtodetal", "ЮГАВТОДЕТАЛЬ", "YUGDETAL", "yugavtodetal.png", [
    "югавтодеталь",
    "юг автодеталь",
    "yugavtodetal",
  ]),
  filePreset("uniqom", "UNIQUM", "UNIQOM", "uniqom.png", [
    "uniqum",
    "uniqom",
    "уникум",
  ]),
  filePreset("service-gear", "Сервис-шестерня", "SRVGEAR", "service-gear.png", [
    "сервис-шестерня",
    "сервис шестерня",
    "service-gear",
    "service gear",
  ]),
  filePreset("vin-parts", "VIN-PARTS.RU", "VINPARTS", "vin-parts.png", [
    "vin-parts.ru",
    "vin-parts",
    "vinparts",
    "вин-партс",
  ]),
  filePreset("vinttop", "VintTop", "VINTTOP", "vinttop.png", [
    "vinttop",
    "vint top",
    "винттоп",
  ]),
  filePreset("volvo77", "VOLVO 77", "VOLVO77", "volvo77.png", [
    "volvo 77",
    "volvo77",
    "вольво 77",
  ]),
  filePreset("voskhod", "ВОСХОД", "VOSKHOD", "voskhod.png", [
    "восход",
    "voskhod",
    "восход авто",
  ]),
  filePreset("vympel", "ВЫМПЕЛ", "VYMPEL", "vympel.png", [
    "вымпел",
    "vympel",
    "вымпел авто",
  ]),
  filePreset("yugtrendavto", "ЮгТрендАвто", "YUGTREND", "yugtrendavto.png", [
    "югтрендавто",
    "юг тренд авто",
    "yugtrendavto",
  ]),
  filePreset("yurbel", "Юрбел", "YURBEL", "yurbel.png", [
    "юрбел",
    "yurbel",
    "юр бел",
  ]),
  ...
  },
  {
    ...
    aliases: ["exist", "экзист", "exist.ru", "exist ru"],
  },
];
